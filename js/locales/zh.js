...
I18n.register('zh', {
    ...
    info: {
        1: 'Arc 是 USDC 发行方 Circle 推出的开放式一层区块链。它兼容 EVM，专为稳定币金融而设计。Arc 公共主网已于 2026 年 9 月 16 日上线，这款游戏的分数正是在那里结算：Gas 用的是真实 USDC，而且由游戏替你支付。',
        ...
        19: 'Arc 公共主网已于 2026 年 9 月 16 日上线：Gas 以 USDC 支付，最终性在一秒以内，并由一组许可制的创始验证者运行。仍在前方的是 ARC 代币，以及它旨在推动的从权威证明（PoA）到权益证明（PoS）的过渡。你在网络建设期间走完了这段路——而你的分数，写在它最终成为的那张主网上。',
